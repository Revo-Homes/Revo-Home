...
const SERVICES = [
  ...
  category: 'Legal',
  description:
    'Create legally valid rent agreements with ease. Get verified documents for tenants and landlords with minimal effort.',
  features: ['Rental Agreement Draft', 'Tenant Verification', 'E-Stamping', 'Legal Compliance'],
  cta: 'Create Agreement',
  link: '/tools/rent-agreement',
  hasComponent: true,
},
  {
    id: 'interior',
  ...
  },
{
  ...
  category: 'Services',
  description:
    'Get expert Vastu consultation to improve harmony, positivity, and energy flow in your home or office.',
  features: ['Home Vastu Check', 'Office Vastu', 'Remedies', 'Direction Analysis'],
  cta: 'Consult Now',
  link: '/contact',
  hasComponent: true,
},
{
  ...
  category: 'Services',
  description:
    'Build your dream home with trusted construction partners. End-to-end services from planning to execution.',
  features: ['Architecture Planning', 'Construction', 'Material Supply', 'Project Management'],
  cta: 'Start Building',
  link: '/contact',
  hasComponent: true,
},
