...
function HomeLoanAssistance() {
    ...
    return (
      <div className="max-w-xl mx-auto px-4 py-12 text-center">
        <div className="bg-green-50 border border-green-200 rounded-xl p-8">
          ...
          <p className="text-gray-600 mb-6">Our loan experts will contact you within 24 hours.</p>
          {/* <Link to="/tools" className="text-primary font-semibold hover:underline">Back to Tools</Link> */}
        </div>
      </div>
    );
  }
  ...
  return (
  <div className="w-full min-h-screen px-6 md:px-10 lg:px-16 py-10">
    
    {/* Header */}
    <div className="mb-8">
      <h2 className="text-2xl font-semibold text-slate-900">Home Loan Assistance</h2>
      <p className="text-slate-500">Get in touch with our partner banks for the best home loan rates</p>
    </div>
    ...
    <div className="w-full">
      <form
        ...
        className="w-full bg-slate-50 rounded-xl p-6 md:p-8 border border-slate-200 space-y-6"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              required
              className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-primary"
            />
          </div>
        ...
        <div>
          <label className="block text-sm font-medium text-slate-700 mb-1">Preferred Bank</label>
          <select
            name="bank"
            value={formData.bank}
            onChange={handleChange}
