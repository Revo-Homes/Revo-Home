    ...
    return (
      <div className="p-6 md:p-8">
        <div className="bg-slate-50 rounded-xl p-8 text-center">
          ...
          <p className="text-slate-600 mb-6">Our experts will contact you within 24 hours.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="p-6 md:p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Property Agreement</h2>
            <p className="text-slate-500">Professional agreement drafting and review</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-3">
          <div className="bg-slate-50 rounded-xl p-6">
            <h3 className="text-lg font-semibold text-slate-900 mb-4">Get Agreement Assistance</h3>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-sm text-slate-600">I agree to be contacted by banks and REVO HOMES for agreement assistance</span>
              </label>
              <button
                type="submit"
